...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1560063736824797237, ; hash 0x15a675b3fc691835, from name: Academy
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6188357574725938406, ; hash 0x55e1766d48a32ce6, from name: libaot-Academy
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	...
	%struct.DSOCacheEntry {
		i64 9844028624317386184, ; hash 0x889d03e0bf370dc8, from name: Academy.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 246
	...
	%struct.DSOCacheEntry {
		i64 11653969546568948731, ; hash 0xa1bb378ea6765bfb, from name: aot-Academy.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 298
	...
	%struct.DSOCacheEntry {
		i64 13587305964101811445, ; hash 0xbc8fcec924d5bcf5, from name: libaot-Academy.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 13727843366287252728, ; hash 0xbe8318cef3c11cf8, from name: aot-Academy
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Academy.dll.so
		ptr null; void* handle (0x0)
	}, ; 355
...
@.env.3 = private unnamed_addr constant [37 x i8] c"2b62465f-260e-4cac-96d0-51d7080aa710\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.academy\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Academy.dll.so\00", align 16
